...
| 3. Architektur/Design (inkl. ADR Eigenbau vs. EVCC vs. Hybrid) | specs/03-architecture.md | ⚪ offen |
...
Phase 1 (Requirements) läuft. Der Katalog in `specs/01-requirements.md` enthält Kandidaten im Status *Entwurf*; am Phasenende werden sie gemeinsam sortiert und per MoSCoW priorisiert. Eine Architektur- oder Tech-Stack-Entscheidung ist bewusst **noch nicht** getroffen.
